...
interface FileUploadProps {
  ...
  // New props for Profile-First UX
  currentFile?: File | null; // Replaces 'fileName' usage in logic
  fileName?: string | null; // Keep for backward compatibility or simple display
  defaultFileName?: string | null; // If provided, shows as pre-filled from profile
  isProfileDoc?: boolean; // If true, shows "From Profile" badge
  id: string;
}
