...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
            ...
            {/* 1. HERO SECTION */}
            <section className="relative bg-white min-h-[500px] lg:min-h-[600px] flex items-center pt-6 pb-12 lg:pt-16 lg:pb-16 overflow-hidden">
                ...
                <div className="container mx-auto px-5 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
                    <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 bg-white px-4 py-2 lg:px-5 lg:py-2.5 rounded-full border border-teal-100 mb-4 lg:mb-6 shadow-[0_2px_20px_-5px_rgba(20,184,166,0.15)] mx-auto lg:mx-0">
                        ...
                        {/* Headline */}
                        <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-slate-900 leading-[1.1] tracking-tight mb-4 lg:mb-6">
                        ...
                        {/* Subheadline */}
                        <p className="text-slate-500 text-base md:text-lg lg:text-xl max-w-lg mb-6 lg:mb-8 leading-relaxed font-medium mx-auto lg:mx-0">
                ...
                <div className="container mx-auto px-5 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="order-1 lg:order-2 text-center lg:text-left">
                        ...
                        <button
                            ...
                            className="w-full lg:w-auto px-10 py-4 lg:py-5 bg-[#0b1a33] text-white rounded-2xl font-black uppercase text-[10px] tracking-[0.2em] hover:bg-black hover:scale-105 transition-all shadow-xl"
                        >
                            Get Started
                        </button>
                    </div>
            ...
            <section className="py-12 lg:py-20 bg-[#f8fafc]">
                <div className="container mx-auto px-5 lg:px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
                        {[
                            {
                                title: "How to Ace Your Hospitality Interview",
                                date: "OCT 24, 2025",
                                img: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=800",
                                link: "https://www.shortcoursesau.edu.au/blog/how-to-ace-your-hospitality-interview/"
                            },
                            {
                                title: "A Guide to Obtaining Work Visa in Maldives",
                                date: "OCT 20, 2025",
                                img: "https://images.unsplash.com/photo-1544717297-fa95b6ee9643?q=80&w=800",
                                link: "https://immigration.gov.mv/work-visa/"
                            },
                            {
                                title: "Top 10 Soft Skills for Hospitality Professionals",
                                date: "OCT 15, 2025",
                                img: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=800",
                                link: "https://www.ehl.edu/insights/essential-soft-skills-hospitality"
                            }
                        ].map((article, i) => (
                            <a href={article.link} target="_blank" rel="noopener noreferrer" key={i} className="group bg-white rounded-[2rem] lg:rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
