...
const CandidateProfile: React.FC<{
  ...
  profileData: any;
  docs: any[];
  handleDocAction: (id: string) => void;
  handleDeleteItem: (id: string, req: boolean) => void;
  setIsResettingPassword: (v: boolean) => void;
  setIsEditingPersonal: (v: boolean) => void;
  previewImage: string | null;
  isAddingDoc: boolean;
  setIsAddingDoc: (v: boolean) => void;
  newDocName: string;
  setNewDocName: (v: string) => void;
  handleAddDoc: () => void;
}> = ({ user, profileData, docs, handleDocAction, handleDeleteItem, setIsResettingPassword, setIsEditingPersonal, previewImage, isAddingDoc, setIsAddingDoc, newDocName, setNewDocName, handleAddDoc }) => {
  return (
    <>
...
const AgentProfile: React.FC<{
  ...
  setIsEditingPersonal: (v: boolean) => void;
  previewImage: string | null;
}> = ({ user, profileData, docs, handleDocAction, setIsResettingPassword, setIsEditingPersonal, previewImage }) => {
  return (
    <>
...
const ProfilePage: React.FC = () => {
  ...
  const handleDocAction = (id: string) => {
  ...
  const handleDeleteItem = (id: string, isRequired: boolean) => {
