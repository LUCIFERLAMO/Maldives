...
#### 3. File Interface (GridFS)

- **Uploads:** The user uploads PDFs/JPEGs (resumes, passports).
- **Storage:** Files stored securely in MongoDB using GridFS.
- **Security:**
...
| :--- | :---: |
| **6.1.1 Operational Feasibility:**<br><br>This system is highly operationally feasible as it directly addresses the critical need for a centralized, transparent platform for international recruitment.<br><br>**Candidate Benefit:** Candidates gain a unified interface to upload documents (Passport, PCC, Resume) and track application status in real-time. The **Real-time Status Dashboard** ensures instant updates.<br><br>**Organization Benefit:** The "3-User Architecture" streamlines the vetting process using standardized profiles. Automated document checks ensure compliance with employment laws. | **30 %** |
